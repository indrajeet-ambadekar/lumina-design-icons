      ...
      {buttonsLength > 1 ? (
        <>
          <div
            ...
            className={[styles["elc_ui-toggle-nav"], "elc_ui-toggle-nav"].join(
              " "
            )}
            style={{
              ...container,
          ...
          {enable && isMenuIdentifier && (
            <div
              className={`${styles["elc_ui-menu-identifier"]} ${className}`}
              style={{
                ...identifier,
